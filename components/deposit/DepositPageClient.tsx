...
export function DepositPageClient() {
  ...
  // Fetch portfolio history for chart data. Snapshot writes are owned by
  // event-driven flows (deposit, withdrawal, trade) and the 15-minute cron
  // on vaulto-api — no client-side reconcile loop is needed.
